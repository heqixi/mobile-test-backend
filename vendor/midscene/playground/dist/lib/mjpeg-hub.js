...
__webpack_require__.d(__webpack_exports__, {
    createInterfaceMjpegHub: ()=>createInterfaceMjpegHub,
    writeMjpegFrame: ()=>writeMjpegFrame,
    InterfaceMjpegHub: ()=>InterfaceMjpegHub
});
...
function createInterfaceMjpegHub(opts) {
    return new InterfaceMjpegHub({
        ...opts,
        debug: opts.debug ?? (0, logger_namespaceObject.getDebug)('playground:mjpeg-hub')
    });
}
exports.InterfaceMjpegHub = __webpack_exports__.InterfaceMjpegHub;
exports.createInterfaceMjpegHub = __webpack_exports__.createInterfaceMjpegHub;
exports.writeMjpegFrame = __webpack_exports__.writeMjpegFrame;
...
//# sourceMappingURL=mjpeg-hub.js.map