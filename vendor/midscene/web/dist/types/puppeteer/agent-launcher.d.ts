...
import { type Browser, type DownloadBehavior, type Page } from 'puppeteer';
...
export declare function buildDownloadBehavior(downloadPath: string | undefined): DownloadBehavior | undefined;
