...
import { AbstractInterface, type BrowserInputPrimitives, type DeviceAction } from '@midscene/core/device';
...
export declare abstract class AbstractWebPage extends AbstractInterface {
    ...
    abstract pinch(centerX: number, centerY: number, startDistance: number, endDistance: number, duration?: number): Promise<void>;
}
export declare function createWebInputPrimitives(page: AbstractWebPage): BrowserInputPrimitives;
