...
import type { AbstractInterface, DeviceAction, FileChooserHandler, FileChooserRegistration } from '@midscene/core/device';
...
export default class ChromeExtensionProxyPage implements AbstractInterface {
    ...
    private activeTabId;
    private destroyed;
    private fileChooserEventHandler?;
    private fileChooserRegistrationVersion;
    ...
    registerFileChooserAccept(files: string[]): Promise<void>;
    clearFileChooserAccept(): void;
    getFileChooserError(): Promise<{
        message: string;
        name?: string;
        stack?: string;
    } | undefined>;
