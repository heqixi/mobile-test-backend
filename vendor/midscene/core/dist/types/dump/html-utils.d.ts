import type { IReportActionDump } from '../types';
export declare const escapeContent: (html: string) => string;
export declare const unescapeContent: (html: string) => string;
export declare function generateAgentReportComment(report: IReportActionDump): string;
 ...
 */
export declare const DATA_SCREENSHOT_MODE_ATTR = "data-screenshot-mode";
