...
import type { IModelConfig, TIntent, TModelReasoningEnabled, TModelResponseFormat } from '@midscene/shared/env';
import type OpenAI from 'openai';
import type { JsonParser, JsonParserContext, JsonParserSource } from '../service-caller/json';
import type { LocateResultAdapter, LocateResultAdapterDefinition, ResolvedLocateResultCoordinates } from '../shared/model-locate-result/types';
...
export type ChatCompletionContentSource = (OpenAI.Chat.Completions.ChatCompletionMessage & {
    reasoning_content?: string;
}) | (OpenAI.Chat.Completions.ChatCompletionChunk.Choice.Delta & {
    reasoning_content?: string;
});
export type ExtractContentAndReasoning = (message: ChatCompletionContentSource | undefined) => ContentAndReasoning;
