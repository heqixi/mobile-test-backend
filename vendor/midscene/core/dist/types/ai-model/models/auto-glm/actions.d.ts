...
type CoordinateDistanceToPixels = (delta: number, axis: CoordinateDistanceAxis) => number;
...
export type AutoGLMParsedAction = TapAction | DoubleTapAction | TypeAction | SwipeAction | LongPressAction | LaunchAction | BackAction | HomeAction | WaitAction | InteractAction | CallAPIAction | TakeoverAction | NoteAction | FinishAction;
export declare function transformAutoGLMAction(action: AutoGLMParsedAction, { actionSpace, coordinateDistanceToPixels, }: {
