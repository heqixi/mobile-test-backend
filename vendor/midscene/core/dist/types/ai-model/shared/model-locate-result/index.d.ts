...
export { isBboxLocateResultValue, isPointLocateResultValue, } from './types';
export type { CoordinateDistanceAxis } from './coordinate-distance';
export { createLocateResultValue, parseCoordinateList, unwrapCoordinateListLikeInput, } from './parse';
