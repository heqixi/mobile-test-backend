...
export type PointLocateResultValue = Extract<LocateResultValue, {
    coordinatesMeta: {
        shape: 'point';
    };
}>;
export type BboxLocateResultValue = Extract<LocateResultValue, {
    coordinatesMeta: {
        shape: 'bbox';
    };
}>;
export declare function isBboxLocateResultValue(result: LocateResultValue): result is BboxLocateResultValue;
export declare function isPointLocateResultValue(result: LocateResultValue): result is PointLocateResultValue;
