import { type ExecutionDump, ReportActionDump, type ReportAttributes, type ReportMeta, type ScreenshotMode } from './types';
...
export declare class ReportGenerator implements IReportGenerator {
    ...
    private executionsByKey;
    private executionCommentKeyByObject;
    private executionCommentKeyIndex;
    private reportAttributes;
    private agentCommentWritten;
    private writeQueue;
    private destroyed;
    constructor(options: {
        reportPath: string;
    ...
    private appendAgentReportComment;
    private getExecutionLogKey;
    private getExecutionCommentKey;
