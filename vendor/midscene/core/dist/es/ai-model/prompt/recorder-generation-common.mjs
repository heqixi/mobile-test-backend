...
const getScreenshotsForLLM = (events, maxScreenshots = 1)=>createMidsceneRecorderMarkdownScreenshotAssets(events, {
        baseDir: './screenshots',
        maxScreenshots
...
function prepareRecorderGenerationContext(input) {
    ...
    const maxScreenshots = input.maxScreenshots ?? DEFAULT_MIDSCENE_RECORDER_MARKDOWN_MAX_SCREENSHOTS;
    const screenshotAssets = createMidsceneRecorderMarkdownScreenshotAssets(input.events, {
        baseDir: './screenshots',
        maxScreenshots
    });
