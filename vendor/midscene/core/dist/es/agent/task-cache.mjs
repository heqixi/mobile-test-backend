...
class TaskCache {
    ...
    constructor(cacheId, isCacheResultUsed, cacheFilePath, options = {}){
        ...
        this.cacheFilePath = ifInBrowser || ifInWorker ? void 0 : cacheFilePath || join(cacheDir || getMidsceneRunSubDir('cache'), `${this.cacheId}${cacheFileExt}`);
