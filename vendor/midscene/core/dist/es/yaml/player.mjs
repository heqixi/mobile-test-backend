...
class ScriptPlayer {
    ...
    async playFlowItem(agent, flowItem, flowItemRecord, flowItemIndex) {
        ...
        if ('aiAct' in flowItem || 'aiAction' in flowItem || 'ai' in flowItem) {
            ...
            assert(!Object.prototype.hasOwnProperty.call(assertTask, 'observe'), '`observe` is not supported in YAML aiAssert. Use agent.startObserving() from code instead.');
            ...
            assert(!Object.prototype.hasOwnProperty.call(flowItem, 'observe'), '`observe` is not supported in YAML flow items. Use agent.startObserving() from code instead.');
