...
const actionInputParamSchema = z.object({
    ...
    keyboardTypeDelay: z.number().optional().describe('Delay in milliseconds between keystrokes when typing. Passed through from device/user configuration. Do not set it unless the user asks you to do so.')
});
