...
__webpack_require__.d(__webpack_exports__, {
    getAutoGLMChineseLocatePrompt: ()=>getAutoGLMChineseLocatePrompt,
    getAutoGLMChinesePlanPrompt: ()=>getAutoGLMChinesePlanPrompt,
    getAutoGLMMultilingualLocatePrompt: ()=>getAutoGLMMultilingualLocatePrompt,
    getAutoGLMMultilingualPlanPrompt: ()=>getAutoGLMMultilingualPlanPrompt
});
...
`;
const getAutoGLMMultilingualLocatePrompt = ()=>`
The current date: ${getMultilingualFormattedDate()}
...
- Your goal is to locate and tap the UI element specified by the user (e.g., button, icon, link, etc.). Do not attempt any other actions.
  `;
const getAutoGLMChineseLocatePrompt = ()=>`
今天的日期是: ${getChineseFormattedDate()}
...
- 你的目标是定位并点击用户指定的UI元素（例如按钮、图标、链接等），请不要尝试任何其他的操作。
    `;
exports.getAutoGLMChineseLocatePrompt = __webpack_exports__.getAutoGLMChineseLocatePrompt;
exports.getAutoGLMChinesePlanPrompt = __webpack_exports__.getAutoGLMChinesePlanPrompt;
exports.getAutoGLMMultilingualLocatePrompt = __webpack_exports__.getAutoGLMMultilingualLocatePrompt;
exports.getAutoGLMMultilingualPlanPrompt = __webpack_exports__.getAutoGLMMultilingualPlanPrompt;
