...
const warn = (0, logger_namespaceObject.getDebug)('cache', {
    console: true
});
...
class TaskCache {
    ...
    replaceCacheRecord(index, newRecord) {
        ...
        external_node_assert_default()(target.type === newRecord.type, `cache record type mismatch on replace: expected ${newRecord.type}, got ${target.type}`);
    ...
    constructor(cacheId, isCacheResultUsed, cacheFilePath, options = {}){
        ...
        this.cacheFilePath = utils_namespaceObject.ifInBrowser || utils_namespaceObject.ifInWorker ? void 0 : cacheFilePath || (0, external_node_path_namespaceObject.join)(cacheDir || (0, common_namespaceObject.getMidsceneRunSubDir)('cache'), `${this.cacheId}${cacheFileExt}`);
