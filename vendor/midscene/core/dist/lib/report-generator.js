...
class ReportGenerator {
    ...
    printReportPath() {
        ...
        if ('directory' === this.screenshotMode) (0, utils_namespaceObject.logMsg)(`Midscene - report file updated: npx serve ${(0, external_node_path_namespaceObject.dirname)(this.reportPath)}`);
        else (0, utils_namespaceObject.logMsg)(`Midscene - report file updated: ${this.reportPath}`);
    }
    ...
    getDumpScriptAttributes() {
        return {
            ...
            [html_utils_js_namespaceObject.DATA_SCREENSHOT_MODE_ATTR]: this.screenshotMode,
