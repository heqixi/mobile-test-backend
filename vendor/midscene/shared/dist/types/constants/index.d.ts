...
export declare const PREVIEW_TEXT_INPUT_BATCH_DELAY_MS = 120;
export declare const PREVIEW_WHEEL_SCROLL_BATCH_DELAY_MS = 80;
export declare const RECORDER_SCROLL_BATCH_DELAY_MS = 200;
export declare const RECORDER_INPUT_BATCH_DELAY_MS = 300;
