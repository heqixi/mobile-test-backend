...
const INSIGHT_MODEL_CONFIG_KEYS = {
    ...
    responseFormat: external_types_js_namespaceObject.MIDSCENE_INSIGHT_MODEL_RESPONSE_FORMAT
};
const PLANNING_MODEL_CONFIG_KEYS = {
    ...
    responseFormat: external_types_js_namespaceObject.MIDSCENE_PLANNING_MODEL_RESPONSE_FORMAT
};
const DEFAULT_MODEL_CONFIG_KEYS = {
    ...
    responseFormat: external_types_js_namespaceObject.MIDSCENE_MODEL_RESPONSE_FORMAT
};
