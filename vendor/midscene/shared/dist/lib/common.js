...
__webpack_require__.d(__webpack_exports__, {
    ...
    setMidsceneRunDir: ()=>setMidsceneRunDir,
...
let configuredRunDir;
const setMidsceneRunDir = (runDir)=>{
    configuredRunDir = runDir;
};
const getMidsceneRunDir = ()=>{
    if (!external_utils_js_namespaceObject.ifInNode) return '';
    return configuredRunDir ?? (0, basic_js_namespaceObject.getBasicEnvValue)(types_js_namespaceObject.MIDSCENE_RUN_DIR) ?? defaultRunDirName;
};
...
exports.setMidsceneRunDir = __webpack_exports__.setMidsceneRunDir;
